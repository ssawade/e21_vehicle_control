...
void profile_generator_refac(
    ...
    if (override) {
        ...
        float v_diff = vec_out[0] - vec_out[1];  //v_target - v_0
    ...
    //memmove(debug, vec_in, sizeof(vec_in[0]) * VEC_SIZE);
}